...
Peach92: gsl.#Service & {
	...
	context: Peach92.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach92"
	display_name:  "Foobar 2 Peach92"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach92 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach92 service.
