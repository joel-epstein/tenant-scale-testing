...
Peach39: gsl.#Service & {
	...
	context: Peach39.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach39"
	display_name:  "Foobar 2 Peach39"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach39 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach39 service.
