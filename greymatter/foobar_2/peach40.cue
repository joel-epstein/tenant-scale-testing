...
Peach40: gsl.#Service & {
	...
	context: Peach40.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach40"
	display_name:  "Foobar 2 Peach40"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach40 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach40 service.
