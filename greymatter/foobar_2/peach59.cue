...
Peach59: gsl.#Service & {
	...
	context: Peach59.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach59"
	display_name:  "Foobar 2 Peach59"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach59 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach59 service.
