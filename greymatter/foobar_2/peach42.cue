...
Peach42: gsl.#Service & {
	...
	context: Peach42.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach42"
	display_name:  "Foobar 2 Peach42"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach42 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach42 service.
