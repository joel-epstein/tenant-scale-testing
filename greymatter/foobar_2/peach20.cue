...
Peach20: gsl.#Service & {
	...
	context: Peach20.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach20"
	display_name:  "Foobar 2 Peach20"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach20 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach20 service.
