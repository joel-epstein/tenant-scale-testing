...
Peach55: gsl.#Service & {
	...
	context: Peach55.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach55"
	display_name:  "Foobar 2 Peach55"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach55 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach55 service.
