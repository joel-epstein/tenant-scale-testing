...
Peach53: gsl.#Service & {
	...
	context: Peach53.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach53"
	display_name:  "Foobar 2 Peach53"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach53 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach53 service.
