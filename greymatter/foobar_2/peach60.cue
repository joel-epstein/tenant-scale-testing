...
Peach60: gsl.#Service & {
	...
	context: Peach60.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach60"
	display_name:  "Foobar 2 Peach60"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach60 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach60 service.
