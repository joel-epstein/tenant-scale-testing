...
Peach98: gsl.#Service & {
	...
	context: Peach98.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach98"
	display_name:  "Foobar 2 Peach98"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach98 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach98 service.
