...
Peach23: gsl.#Service & {
	...
	context: Peach23.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach23"
	display_name:  "Foobar 2 Peach23"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach23 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach23 service.
