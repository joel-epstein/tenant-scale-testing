...
Peach63: gsl.#Service & {
	...
	context: Peach63.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach63"
	display_name:  "Foobar 2 Peach63"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach63 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach63 service.
