...
Peach44: gsl.#Service & {
	...
	context: Peach44.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach44"
	display_name:  "Foobar 2 Peach44"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach44 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach44 service.
