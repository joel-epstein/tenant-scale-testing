...
Peach89: gsl.#Service & {
	...
	context: Peach89.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach89"
	display_name:  "Foobar 2 Peach89"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach89 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach89 service.
