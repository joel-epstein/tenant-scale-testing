...
Peach83: gsl.#Service & {
	...
	context: Peach83.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach83"
	display_name:  "Foobar 2 Peach83"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach83 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach83 service.
