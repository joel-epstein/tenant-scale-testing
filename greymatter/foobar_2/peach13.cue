...
Peach13: gsl.#Service & {
	...
	context: Peach13.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach13"
	display_name:  "Foobar 2 Peach13"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach13 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach13 service.
