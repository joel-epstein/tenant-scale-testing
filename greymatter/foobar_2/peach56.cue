...
Peach56: gsl.#Service & {
	...
	context: Peach56.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach56"
	display_name:  "Foobar 2 Peach56"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach56 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach56 service.
