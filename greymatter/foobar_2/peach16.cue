...
Peach16: gsl.#Service & {
	...
	context: Peach16.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach16"
	display_name:  "Foobar 2 Peach16"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach16 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach16 service.
