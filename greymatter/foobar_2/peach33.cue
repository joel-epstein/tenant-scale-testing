...
Peach33: gsl.#Service & {
	...
	context: Peach33.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach33"
	display_name:  "Foobar 2 Peach33"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach33 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach33 service.
