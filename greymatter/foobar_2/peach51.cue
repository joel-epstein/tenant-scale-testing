...
Peach51: gsl.#Service & {
	...
	context: Peach51.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach51"
	display_name:  "Foobar 2 Peach51"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach51 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach51 service.
