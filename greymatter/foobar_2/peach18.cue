...
Peach18: gsl.#Service & {
	...
	context: Peach18.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach18"
	display_name:  "Foobar 2 Peach18"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach18 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach18 service.
