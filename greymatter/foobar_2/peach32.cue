...
Peach32: gsl.#Service & {
	...
	context: Peach32.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach32"
	display_name:  "Foobar 2 Peach32"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach32 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach32 service.
