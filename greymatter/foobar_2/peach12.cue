...
Peach12: gsl.#Service & {
	...
	context: Peach12.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach12"
	display_name:  "Foobar 2 Peach12"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach12 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach12 service.
