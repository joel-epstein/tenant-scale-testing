...
Peach17: gsl.#Service & {
	...
	context: Peach17.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach17"
	display_name:  "Foobar 2 Peach17"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach17 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach17 service.
