...
Peach19: gsl.#Service & {
	...
	context: Peach19.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach19"
	display_name:  "Foobar 2 Peach19"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach19 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach19 service.
