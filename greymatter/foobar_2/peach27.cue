...
Peach27: gsl.#Service & {
	...
	context: Peach27.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach27"
	display_name:  "Foobar 2 Peach27"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach27 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach27 service.
