...
Peach94: gsl.#Service & {
	...
	context: Peach94.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach94"
	display_name:  "Foobar 2 Peach94"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach94 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach94 service.
