...
Peach64: gsl.#Service & {
	...
	context: Peach64.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach64"
	display_name:  "Foobar 2 Peach64"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach64 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach64 service.
