...
Peach91: gsl.#Service & {
	...
	context: Peach91.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach91"
	display_name:  "Foobar 2 Peach91"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach91 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach91 service.
