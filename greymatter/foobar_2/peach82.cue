...
Peach82: gsl.#Service & {
	...
	context: Peach82.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach82"
	display_name:  "Foobar 2 Peach82"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach82 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach82 service.
