...
Peach84: gsl.#Service & {
	...
	context: Peach84.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach84"
	display_name:  "Foobar 2 Peach84"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach84 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach84 service.
