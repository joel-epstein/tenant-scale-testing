...
Peach38: gsl.#Service & {
	...
	context: Peach38.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach38"
	display_name:  "Foobar 2 Peach38"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach38 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach38 service.
