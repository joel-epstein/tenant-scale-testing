...
Peach37: gsl.#Service & {
	...
	context: Peach37.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach37"
	display_name:  "Foobar 2 Peach37"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach37 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach37 service.
