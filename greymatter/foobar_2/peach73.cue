...
Peach73: gsl.#Service & {
	...
	context: Peach73.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach73"
	display_name:  "Foobar 2 Peach73"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach73 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach73 service.
