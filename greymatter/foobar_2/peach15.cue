...
Peach15: gsl.#Service & {
	...
	context: Peach15.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach15"
	display_name:  "Foobar 2 Peach15"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach15 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach15 service.
