...
Peach75: gsl.#Service & {
	...
	context: Peach75.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach75"
	display_name:  "Foobar 2 Peach75"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach75 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach75 service.
