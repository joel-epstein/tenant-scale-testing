...
Peach93: gsl.#Service & {
	...
	context: Peach93.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach93"
	display_name:  "Foobar 2 Peach93"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach93 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach93 service.
