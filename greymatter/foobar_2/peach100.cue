...
Peach100: gsl.#Service & {
	// A context provides global information from globals.cue
	// to your service definitions.
	context: Peach100.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach100"
	display_name:  "Foobar 2 Peach100"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach100 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach100 service.
