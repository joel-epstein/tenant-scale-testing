...
Peach41: gsl.#Service & {
	...
	context: Peach41.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach41"
	display_name:  "Foobar 2 Peach41"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach41 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach41 service.
