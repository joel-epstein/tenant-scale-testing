...
Peach22: gsl.#Service & {
	...
	context: Peach22.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach22"
	display_name:  "Foobar 2 Peach22"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach22 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach22 service.
