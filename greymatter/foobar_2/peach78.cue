...
Peach78: gsl.#Service & {
	...
	context: Peach78.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach78"
	display_name:  "Foobar 2 Peach78"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach78 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach78 service.
