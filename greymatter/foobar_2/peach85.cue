...
Peach85: gsl.#Service & {
	...
	context: Peach85.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach85"
	display_name:  "Foobar 2 Peach85"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach85 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach85 service.
