...
Peach31: gsl.#Service & {
	...
	context: Peach31.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach31"
	display_name:  "Foobar 2 Peach31"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach31 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach31 service.
