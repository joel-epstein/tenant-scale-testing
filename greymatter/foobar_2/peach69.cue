...
Peach69: gsl.#Service & {
	...
	context: Peach69.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach69"
	display_name:  "Foobar 2 Peach69"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach69 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach69 service.
