...
Peach52: gsl.#Service & {
	...
	context: Peach52.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach52"
	display_name:  "Foobar 2 Peach52"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach52 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach52 service.
