...
Peach58: gsl.#Service & {
	...
	context: Peach58.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach58"
	display_name:  "Foobar 2 Peach58"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach58 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach58 service.
