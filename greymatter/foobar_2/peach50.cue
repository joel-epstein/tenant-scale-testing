...
Peach50: gsl.#Service & {
	...
	context: Peach50.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach50"
	display_name:  "Foobar 2 Peach50"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach50 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach50 service.
