...
Peach66: gsl.#Service & {
	...
	context: Peach66.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach66"
	display_name:  "Foobar 2 Peach66"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach66 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach66 service.
