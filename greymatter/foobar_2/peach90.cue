...
Peach90: gsl.#Service & {
	...
	context: Peach90.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach90"
	display_name:  "Foobar 2 Peach90"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach90 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach90 service.
