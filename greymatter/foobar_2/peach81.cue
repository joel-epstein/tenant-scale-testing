...
Peach81: gsl.#Service & {
	...
	context: Peach81.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach81"
	display_name:  "Foobar 2 Peach81"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach81 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach81 service.
