...
Peach24: gsl.#Service & {
	...
	context: Peach24.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach24"
	display_name:  "Foobar 2 Peach24"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach24 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach24 service.
