...
Peach34: gsl.#Service & {
	...
	context: Peach34.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach34"
	display_name:  "Foobar 2 Peach34"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach34 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach34 service.
