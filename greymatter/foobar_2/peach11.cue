...
Peach11: gsl.#Service & {
	...
	context: Peach11.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach11"
	display_name:  "Foobar 2 Peach11"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach11 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach11 service.
