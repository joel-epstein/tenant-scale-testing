...
Peach14: gsl.#Service & {
	...
	context: Peach14.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach14"
	display_name:  "Foobar 2 Peach14"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach14 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach14 service.
