...
Peach96: gsl.#Service & {
	...
	context: Peach96.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach96"
	display_name:  "Foobar 2 Peach96"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach96 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach96 service.
