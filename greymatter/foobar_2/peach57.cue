...
Peach57: gsl.#Service & {
	...
	context: Peach57.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach57"
	display_name:  "Foobar 2 Peach57"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach57 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach57 service.
