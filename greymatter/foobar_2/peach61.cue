...
Peach61: gsl.#Service & {
	...
	context: Peach61.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach61"
	display_name:  "Foobar 2 Peach61"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach61 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach61 service.
