...
Peach79: gsl.#Service & {
	...
	context: Peach79.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach79"
	display_name:  "Foobar 2 Peach79"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach79 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach79 service.
