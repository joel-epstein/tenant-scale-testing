...
Peach88: gsl.#Service & {
	...
	context: Peach88.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach88"
	display_name:  "Foobar 2 Peach88"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach88 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach88 service.
