...
Peach48: gsl.#Service & {
	...
	context: Peach48.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach48"
	display_name:  "Foobar 2 Peach48"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach48 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach48 service.
