...
Peach74: gsl.#Service & {
	...
	context: Peach74.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach74"
	display_name:  "Foobar 2 Peach74"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach74 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach74 service.
