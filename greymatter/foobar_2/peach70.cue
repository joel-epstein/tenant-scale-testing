...
Peach70: gsl.#Service & {
	...
	context: Peach70.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach70"
	display_name:  "Foobar 2 Peach70"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach70 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach70 service.
