...
Peach80: gsl.#Service & {
	...
	context: Peach80.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach80"
	display_name:  "Foobar 2 Peach80"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach80 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach80 service.
