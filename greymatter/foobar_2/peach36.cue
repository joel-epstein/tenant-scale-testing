...
Peach36: gsl.#Service & {
	...
	context: Peach36.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach36"
	display_name:  "Foobar 2 Peach36"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach36 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach36 service.
