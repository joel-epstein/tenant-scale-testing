...
Peach47: gsl.#Service & {
	...
	context: Peach47.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach47"
	display_name:  "Foobar 2 Peach47"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach47 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach47 service.
