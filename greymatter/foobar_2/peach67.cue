...
Peach67: gsl.#Service & {
	...
	context: Peach67.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach67"
	display_name:  "Foobar 2 Peach67"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach67 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach67 service.
