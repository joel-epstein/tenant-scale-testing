...
Peach26: gsl.#Service & {
	...
	context: Peach26.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach26"
	display_name:  "Foobar 2 Peach26"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach26 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach26 service.
