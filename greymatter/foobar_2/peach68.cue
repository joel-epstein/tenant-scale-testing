...
Peach68: gsl.#Service & {
	...
	context: Peach68.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach68"
	display_name:  "Foobar 2 Peach68"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach68 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach68 service.
