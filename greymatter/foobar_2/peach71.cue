...
Peach71: gsl.#Service & {
	...
	context: Peach71.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach71"
	display_name:  "Foobar 2 Peach71"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach71 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach71 service.
