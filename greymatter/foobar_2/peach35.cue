...
Peach35: gsl.#Service & {
	...
	context: Peach35.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach35"
	display_name:  "Foobar 2 Peach35"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach35 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach35 service.
