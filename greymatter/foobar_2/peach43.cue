...
Peach43: gsl.#Service & {
	...
	context: Peach43.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach43"
	display_name:  "Foobar 2 Peach43"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach43 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach43 service.
