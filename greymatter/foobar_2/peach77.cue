...
Peach77: gsl.#Service & {
	...
	context: Peach77.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach77"
	display_name:  "Foobar 2 Peach77"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach77 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach77 service.
