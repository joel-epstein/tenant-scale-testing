...
Peach21: gsl.#Service & {
	...
	context: Peach21.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach21"
	display_name:  "Foobar 2 Peach21"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach21 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach21 service.
