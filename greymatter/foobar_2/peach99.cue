...
Peach99: gsl.#Service & {
	...
	context: Peach99.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach99"
	display_name:  "Foobar 2 Peach99"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach99 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach99 service.
