...
Peach45: gsl.#Service & {
	...
	context: Peach45.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach45"
	display_name:  "Foobar 2 Peach45"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach45 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach45 service.
