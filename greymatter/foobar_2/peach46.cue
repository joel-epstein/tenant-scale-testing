...
Peach46: gsl.#Service & {
	...
	context: Peach46.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach46"
	display_name:  "Foobar 2 Peach46"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach46 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach46 service.
