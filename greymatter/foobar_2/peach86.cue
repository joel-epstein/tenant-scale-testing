...
Peach86: gsl.#Service & {
	...
	context: Peach86.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach86"
	display_name:  "Foobar 2 Peach86"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach86 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach86 service.
