...
Peach30: gsl.#Service & {
	...
	context: Peach30.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach30"
	display_name:  "Foobar 2 Peach30"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach30 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach30 service.
