...
Peach72: gsl.#Service & {
	...
	context: Peach72.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach72"
	display_name:  "Foobar 2 Peach72"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach72 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach72 service.
