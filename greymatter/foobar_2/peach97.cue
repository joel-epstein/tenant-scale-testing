...
Peach97: gsl.#Service & {
	...
	context: Peach97.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach97"
	display_name:  "Foobar 2 Peach97"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach97 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach97 service.
