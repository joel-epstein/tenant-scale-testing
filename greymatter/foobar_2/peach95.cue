...
Peach95: gsl.#Service & {
	...
	context: Peach95.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach95"
	display_name:  "Foobar 2 Peach95"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach95 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach95 service.
