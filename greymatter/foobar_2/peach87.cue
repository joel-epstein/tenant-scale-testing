...
Peach87: gsl.#Service & {
	...
	context: Peach87.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach87"
	display_name:  "Foobar 2 Peach87"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach87 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach87 service.
