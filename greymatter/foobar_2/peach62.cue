...
Peach62: gsl.#Service & {
	...
	context: Peach62.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach62"
	display_name:  "Foobar 2 Peach62"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach62 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach62 service.
