...
Peach10: gsl.#Service & {
	...
	context: Peach10.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "peach10"
	display_name:  "Foobar 2 Peach10"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Peach10 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
	...
	// Edge config for the Peach10 service.
